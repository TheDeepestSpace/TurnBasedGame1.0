...
import com.turnbasedgame.game.Actors.AI.Tasks.InromablreTaskInterface;
 ...
 */
public class EnemyExistsCondition extends LeafTask<AI> implements InromablreTaskInterface {
    @Override
    ...
    public void informFailed() {
        Console.addLine("ai", "No enemies discovered!", Console.LineType.ERROR);
    }
